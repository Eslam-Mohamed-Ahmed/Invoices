<!-- main-sidebar -->
		...
		<aside class="app-sidebar sidebar-scroll">
			<div class="main-sidebar-header active">
				<a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('assets/img/brand/favicon.png')}}" class="logo-1" alt="logo"></a>
				<h3>Eslam Group</h3>
			</div>
			<div class="main-sidemenu">
				...
				@can('الفواتير')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							@can('قائمة الفواتير')
							<li><a class="slide-item" href="{{ url('/home' . $page='/invoices') }}">قائمة الفواتير</a></li>
							@endcan

							@can('الفواتير المدفوعة')
							<li><a class="slide-item" href="{{ url('/home' . $page='/invoices_paid') }}">الفواتير المدفوعه</a></li>
							@endcan

							@can('الفواتير الغير مدفوعة')
							<li><a class="slide-item" href="{{ url('/home' . $page='/invoices_unpaid') }}">الفواتير الغير مدفوعه</a></li>
							@endcan

							@can('الفواتير المدفوعة جزئيا')
							<li><a class="slide-item" href="{{ url('/home' . $page='/invoices_partial') }}">الفواتير المدفوعه جزئيا</a></li>
							@endcan

							@can('ارشيف الفواتير')
							<li><a class="slide-item" href="{{ url('/home' . $page='/invoices_archive') }}"> الأرشيف </a></li>		
							@endcan
						</ul>
					</li>
				...
				,
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/home' . $page='/sections') }}">الأقسام</a></li>
							<li><a class="slide-item" href="{{ url('/home' . $page='/products') }}">المنتجات</a></li>
						</ul>
					</li>
				</ul>
			</div>
